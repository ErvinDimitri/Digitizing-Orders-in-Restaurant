...
class GuiApp(Tk):
    def __init__(self, *args,**kwargs):
        ...
        self.title('VintageCornerApp')
        self.iconbitmap('icon/icon1.ico')
        self.bgImage = PhotoImage(file='icon/bg.png')
        ...
        self.frames={}
        for F in (MainWindow,ItensWindow,ImpressoraWindow,PedidosWindow):
...
class MainWindow(Frame):
    def __init__(self,parent,controller):
        ...
        bItens.place(relx=0.1, rely=0.3, relheight=0.2, relwidth=0.3)

        # bItens.pack()
        bImpres = Button(self, text="Impressora", command=lambda: controller.show_frame('ImpressoraWindow'))
        bImpres.place(relx=0.4, rely=0.3, relheight=0.2, relwidth=0.3)

        bPedidos = Button(self, text="Historico de Pedidos", command=lambda: controller.show_frame('PedidosWindow'))
        bPedidos.place(relx=0.8, rely=0.3, relheight=0.2, relwidth=0.3)
        # bImpres.pack()
...
class PedidosWindow(Frame):
    def __init__(self,parent,controller):
        ...
        container = ttk.Frame(self,height=400, width=300)#, highlightthickness=1,)
        canvas = Canvas(container, height=300, width=300)  # , highlightthickness=1,highlightbackground='blue')
        ...
        ttk.Label(self, text='Historico de Pedidos: ', font=('Times New Roman', 25)).pack(ipady=30, padx=0.9)
